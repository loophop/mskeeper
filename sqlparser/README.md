# sqlparser [![Build Status](https://img.shields.io/travis/xwb1989/sqlparser.svg)](https://travis-ci.org/xwb1989/sqlparser) [![Coverage](https://img.shields.io/coveralls/xwb1989/sqlparser.svg)](https://coveralls.io/github/xwb1989/sqlparser) [![Report card](https://goreportcard.com/badge/gitlab.papegames.com/fringe/mskeeper/sqlparser)](https://goreportcard.com/report/gitlab.papegames.com/fringe/mskeeper/sqlparser) [![GoDoc](https://godoc.org/gitlab.papegames.com/fringe/mskeeper/sqlparser?status.svg)](https://godoc.org/gitlab.papegames.com/fringe/mskeeper/sqlparser)
...
See [parse_test.go](https://gitlab.papegames.com/fringe/mskeeper/sqlparser/blob/master/parse_test.go) for more examples, or read the [godoc](https://godoc.org/gitlab.papegames.com/fringe/mskeeper/sqlparser).
...
XWB1989=${GOPATH?}/src/gitlab.papegames.com/fringe/mskeeper/sqlparser/
...
# Fix imports
sed -i '.bak' 's_vitess.io/vitess/go/vt/proto/query_gitlab.papegames.com/fringe/mskeeper/sqlparser/dependency/querypb_g' *.go dependency/sqltypes/*.go
sed -i '.bak' 's_vitess.io/vitess/go/_gitlab.papegames.com/fringe/mskeeper/sqlparser/dependency/_g' *.go dependency/sqltypes/*.go
